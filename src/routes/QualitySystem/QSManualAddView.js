...
import { qualityManualUploadService } from 'services';
...
const QSManualAddView = Form.create()(class extends React.Component{
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err,values) => {
      ...
      $.ajax({
        type: "post",
	url: qualityManualUploadService,
	data: formData,
	processData: false,
	contentType: false,
	async: false,
  ...
  render(){
    ...
    return(
      <div>
       <Alert
         message="友情提醒：利用此页面，您可以补录质量手册的历史版本，也可以在当前版本为空时添加质量手册的最新版本，请谨慎操作!"
	 type="warning"
	 closable
       />
       <Card key='0' title='质量手册--添加'>
...
export default QSManualAddView;
