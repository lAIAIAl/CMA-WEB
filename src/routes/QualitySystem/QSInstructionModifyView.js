...
import { qualityInstructionModifyService } from 'services';
...
const QSInstructionModifyView = Form.create()(class extends React.Component{
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err,values) => {
      ...
      const tmpUrl = qualityInstructionModifyService;
      ...
      $.ajax({
        type: "post",
	url: qualityInstructionModifyService,
	data: formData,
	processData: false,
	contentType: false,
	async: false,
  ...
  render(){
    ...
    return(
      <div>
       <Alert
         message="友情提醒：利用此页面，您可以修改作业指导书当前版本的内容，请谨慎操作!"
	 type="warning"
	 closable
       />
       <Card key='0' title='作业指导书--修改'>
...
export default QSInstructionModifyView;
