...
import { Alert, Button, Divider, Form, Input, Row, Col, Upload, Icon, Select, DatePicker, Card, message } from 'antd';

import { qualityManualModifyService } from 'services';
...
const QSManualModifyView = Form.create()(class extends React.Component{
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err,values) => {
      ...
      const tmpUrl = qualityManualModifyService;
      ...
      $.ajax({
        type: "post",
	url: qualityManualModifyService,
	data: formData,
	processData: false,
	contentType: false,
	async: false,
  ...
  render(){
    ...
    return(
      <div>
       <Alert
         message="友情提醒：利用此页面，您可以修改质量手册当前版本的内容，请谨慎操作!"
	 type="warning"
	 closable
       />
       <Card key='0' title='质量手册--修改'>
...
export default QSManualModifyView;
