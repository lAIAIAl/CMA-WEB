...
import { qualityProgramUploadService } from 'services';
...
const QSProgramAddView = Form.create()(class extends React.Component{
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err,values) => {
      ...
      $.ajax({
        type: "post",
	url: qualityProgramUploadService,
	data: formData,
	processData: false,
	contentType: false,
	async: false,
  ...
  render(){
    ...
    return(
      <div>
       <Alert
         message="友情提醒：利用此页面，您可以补录程序文件的历史版本，也可以在当前版本为空时添加程序文件的最新版本，请谨慎操作!"
	 type="warning"
	 closable
       />
       <Card key='0' title='程序文件--添加'>
...
export default QSProgramAddView;
