...
class InternalAuditDocument extends React.Component{
    constructor(props) {
        super(props);
        this.state = {
            /*data: [
    ...
    getAll =()=>{
        $.get("http://119.23.38.100:8080/cma/InternalAuditManagement/getAllFile?year="+this.state.item.year,null,(res)=>{
    ...
    handleAdd = () => {
        ...
        $.ajax({
            type: "post",
            url: "http://119.23.38.100:8080/cma/InternalAuditManagement/addOneFile",
            data: formda,
            processData: false,
            contentType: false,
            async: false,
    ...
    handleOk = () => {
        ...
        $.ajax({
            type: "post",
            url: "http://119.23.38.100:8080/cma/InternalAuditManagement/modifyOneFile",
            data: formda,
            processData: false,
            contentType: false,
            async: false,
    ...
    onDelete = (fileId) => {
            ...
            $.ajax({
            type:"post",
            url:"http://119.23.38.100:8080/cma/InternalAuditManagement/deleteOneFile",
            data:{fileId:fileId},
            async:false,
            success:function(d){
                alert("删除成功");
    ...
    handleDownload = (key) => {
        console.log(key);
        const url = "http://119.23.38.100:8080/cma/InternalAuditManagement/downloadFile?fileId="+key;
    ...
    render() {
        ...
        const addprops = {
            action: "http://119.23.38.100:8080/cma/InternalAuditManagement/addOneFile",
            onRemove: (file) => {
...
InternalAuditDocument = Form.create({})(InternalAuditDocument);
export default InternalAuditDocument