...
import GetStaffTrainView from './GetStaffTrainView';

const FormItem = Form.item;

const StaffDetailView = Form.create()(class extends React.Component{
  ...
  showCurTrains = (props) => {
    this.props.addTab('人员的单次培训', '人员的单次培训', Form.create()(GetStaffTrainView), props);
  }
