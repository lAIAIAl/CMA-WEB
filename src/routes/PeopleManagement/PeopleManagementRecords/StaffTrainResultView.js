...
import { getAllStaffTrainingData } from 'routes/Peoplemanagement/FetchData';

const FormItem = Form.Item;

const Option = Select.Option;

const StaffTrainResultView = Form.create()(class extends React.Component{
...
export default StaffTrainResultView;
